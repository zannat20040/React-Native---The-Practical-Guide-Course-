        ...
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, size }) => (
              <MaterialIcons name="attach-money" size={size} color={color} style={{paddingTop:10}} />
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, size }) => (
              <Feather name="plus" size={size} color={color} style={{paddingTop:10}}/>
            ),
          }}
        />
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, size }) => (
              <FontAwesome5 name="list" size={size} color={color} style={{paddingTop:10}}/>
            )
          }}
        />
      </Tabs.Navigator>
